...
#immune.combined<-subset(immune.combined,subset=Manuscript_Identity=='Baylor')m#subset out the ipf cell atlas
...
genekeep<-rownames(tmp)[rowSums(countdata>0)>ncol(countdata)*0.2] #20% expression cutoff
